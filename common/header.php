...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm position-sticky">
    <div class="container-fluid container-xl">
        <a class="navbar-brand" href="#">Navbar</a>


        <button class="navbar-toggler order-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Przełącz nawigację">
                                    ...
                                    <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <div class="mb-3 form-check">
                                                ...
                                                <label class="form-check-label" for="registerAgree">Zgadza sie z regulaminem</label>
                                            </div>

                                            <button type="submit" class="btn btn-primary" name="btnRegister">Login</button>
                                        </form>
